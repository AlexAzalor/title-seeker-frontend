  ...
  return (
    <div className="grid gap-2">
      ...
      >
        ...
        <div className="absolute top-[25%] right-0 size-5 rounded-full bg-red-200 text-center text-sm font-bold dark:text-black">
          {session.data.user.new_movies_to_add_count}
        </div>
      </Link>
